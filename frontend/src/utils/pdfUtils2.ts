...
export const generarSilaboPDF2 = (silabo: any, silabo2: any, numero: number) => {
  const doc = new jsPDF();
  ...
  const datosIdentificacion = [
    ...
    { label: '1.5.      Sede', value: silabo2.filial.name },
    {
      label: '1.6.      Año - Semestre académico',
      value: silabo2.semestre_academico.nomSemestre,
    },
    ...
    { label: '1.11.    Requisito', value: silabo.prerequisitos },
    {
      ...
      value:
        quitarHora(silabo2.semestre_academico.fInicio) +
        ' - ' +
        quitarHora(silabo2.semestre_academico.fTermino),
    },
