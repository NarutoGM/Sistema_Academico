...
const PersonaModal: React.FC<ModalProps> = ({ isOpen, onClose, onSave }) => {
  ...
  const formatDate = (date: string): string => {
    ...
    return `${day}-${month}-${year}`; // Cambiar a formato d-m-Y
  };
  ...
  const handleSubmit = () => {
    ...
    formData.append('TipoDocIdentidad', tipoDocIdentidad);
    formData.append('FechaNacim', formatDate(fechaNacim));
    ...
    formData.append('idEspecialidad', '1');
