...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-50.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
          ...
          <div>
            ...
            <li>
              ...
              <NavLink
                to="/unidades"
               className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
               pathname.includes('unidades') && 'bg-graydark dark:bg-meta-4'
                  }`}
                    >
                 <svg
                 className="fill-current"
              ...
              <ProtectedElement allowedRoles={['Asesor']}>
                <div className="profesor-section">
                <li>
                <NavLink
                  to="/especialidad"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('especialidad') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
            ...
            <ProtectedElement allowedRoles={['Asesor','Estudiante','Administrador']}>
                <div className="profesor-section">
                <li>
                <NavLink
                  to="/tramite"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('tramite') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
            ...
            <ProtectedElement allowedRoles={['Asesor','Estudiante','Administrador']}>
                ...
                <NavLink
                  to="/tramiteasesor"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('tramiteasesor') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
